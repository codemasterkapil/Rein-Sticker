...
//   // Create a stemmer for lemmatization
//   const stemmer = natural.PorterStemmer;

//   // Tokenize and clean the user's message, including lemmatization
//   const preprocessText = (text) => {
//     const tokens = tokenizer.tokenize(text);

//     // Lemmatize tokens and remove stopwords and punctuation
//     const cleanedTokens = tokens
//       .map((token) => stemmer.stem(token.toLowerCase())) // Lemmatize here using PorterStemmer
